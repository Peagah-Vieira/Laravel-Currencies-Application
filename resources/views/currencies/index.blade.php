...
<html lang="en">
    ...
    <body>
        ...
        <div>
            {{ Session::get('convert_response')->old_amount }}
            {{ Session::get('convert_response')->old_currency }}
            =
            {{ Session::get('convert_response')->new_amount }}
            {{ Session::get('convert_response')->new_currency }}
        </div>
        @endif
        <div>
